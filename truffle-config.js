...
module.exports = {
  ...
  networks: {
    ...
    ropsten: {
      provider: () => new HDWalletProvider( ROPSTEN_PRIVATE_KEY, `https://eth-ropsten.alchemyapi.io/v2/${ALCHEMY_API_KEY}`),
        gasPrice: 250000000000,
        network_id: 3
      },
    fuji: {
      provider: () => new HDWalletProvider(FUJI_PRIVATE_KEY, `https://api.avax-test.network/ext/bc/C/rpc`, 0 , 2),
      network_id: 43113,
      timeoutBlocks: 200,
      confirmations: 5
    },
